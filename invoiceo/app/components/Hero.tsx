		...
		<section className="flex flex-col items-center justify-center relative py-12 lg:py-20">
			<div className="text-center">
				...
				<h1 className="mt-8 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold tracking-tighter">
					Invoicing made{' '}
					<span className="block -mt-2 bg-gradient-to-l from-blue-500 via-teal-500 to-green-500 bg-clip-text text-transparent">
						super easy!
					</span>
				</h1>
			...
			<div className="relative items-center w-full py-12 mx-auto mt-12">
				...
				<Image
					src={HeroImage}
					alt="Hero Image"
					className="w-full h-auto relative object-cover rounded-lg lg:rounded-2xl shadow-2xl "
				/>
			</div>
		</section>
	);
